...
*   **Tuần 1:** Hoàn thành [Lab 1 (Linux Basics)](../00_linux/labs/lab_1_linux_basics.md), [Lab 1 (Python Basics)](../01_python/labs/lab_1_basics.md), [Lab 2 (Python Scripting)](../01_python/labs/lab_2_json_cleansing.md), và [Lab 1 (Docker Basics)](../02_docker/labs/lab_1_docker_postgres.md).
*   **Tuần 2:** Hoàn thành [Lab 2 (Linux Vim)](../00_linux/labs/lab_2_vim.md), [Lab 3 (Linux SSH)](../00_linux/labs/lab_3_ssh_networking.md), [Lab 3 (Python OOP Client)](../01_python/labs/lab_3_weather_client.md), [Lab 6 (Generators & Streaming)](../01_python/labs/lab_6_memory_generators.md), và [Lab 7 (Decorators & Resilience)](../01_python/labs/lab_7_decorators_resilience.md) (yêu cầu slide & thuyết trình).
*   **Tuần 3:** Hoàn thành [Lab 4 (Pandas & NumPy)](../01_python/labs/lab_4_pandas_sales.md) và [Lab 5 (Concurrency)](../01_python/labs/lab_5_parallel_processing.md).
*   **Tuần 4:** Hoàn thành [Lab 1 (MinIO Ingestion)](../04_minio/labs/lab_1_csv_to_minio.md) (Đọc dữ liệu CSV và lưu vào MinIO).
*   **Tuần 5:** Hoàn thành [Lab 2 (Docker Compose & DB Ingestion)](../02_docker/labs/lab_2_compose_stack.md).
*   **Tuần 6:** Hoàn thành [Lab 1 (dbt Transformation)](labs/lab_1_dbt.md).
*   **Tuần 8:** Hoàn thành [Lab 2 (PySpark Big Data)](labs/lab_2_pyspark.md).
*   **Tuần 10:** Hoàn thành [Lab 3 (Capstone Project)](labs/lab_3_capstone.md).
...
> *   📘 **Linux Roadmap:** [roadmap.md](../00_linux/roadmap.md) (CLI, Permissions, Grep/Find, Redirection, Shell Scripting).
> *   *Thực hành:* Hoàn thành [Lab 1 (Linux Basics)](../00_linux/labs/lab_1_linux_basics.md), [Lab 2 (Linux Vim)](../00_linux/labs/lab_2_vim.md), và [Lab 3 (Linux SSH)](../00_linux/labs/lab_3_ssh_networking.md).
...
> *   📘 **Python Roadmap:** [roadmap.md](../01_python/roadmap.md) (OOP, Type Hinting, Logging, Exception Handling, NumPy, Pandas, Concurrency, Pytest).
> *   🐳 **Docker Roadmap:** [roadmap.md](../02_docker/roadmap.md) (Docker CLI, Networking, Volumes, Dockerfile, Docker Compose).
...
*   **Tuần 1: Setup Môi trường, Git, Python Cơ bản & Docker CLI**
    ...
    *   *Thực hành:* Hoàn thành [Lab 1 (Python Basics)](../01_python/labs/lab_1_basics.md), [Lab 2 (Python Scripting)](../01_python/labs/lab_2_json_cleansing.md), và [Lab 1 (Docker Basics)](../02_docker/labs/lab_1_docker_postgres.md).
*   **Tuần 2: Lập trình OOP, Core Python nâng cao & Viết Dockerfile**
    ...
    *   *Thực hành:* Hoàn thành [Lab 3 (Python OOP Client)](../01_python/labs/lab_3_weather_client.md), [Lab 6 (Generators & Streaming)](../01_python/labs/lab_6_memory_generators.md), và [Lab 7 (Decorators & Resilience)](../01_python/labs/lab_7_decorators_resilience.md) (yêu cầu slide & thuyết trình).
*   **Tuần 3: NumPy, Pandas, Xử lý Song song & Docker Compose**
    ...
    *   *Thực hành:* Hoàn thành [Lab 4 (Pandas & NumPy)](../01_python/labs/lab_4_pandas_sales.md) và [Lab 5 (Concurrency)](../01_python/labs/lab_5_parallel_processing.md).
...
*   **Tuần 4: SQL, Relational Databases (PostgreSQL) & Object Storage (MinIO)**
    *   **Lý thuyết & Kỹ năng:**
        ...
        *   **Object Storage & MinIO:** Khái niệm Buckets, Objects, S3-compatible API và cách tương tác bằng Python SDK (Boto3).
    *   **Thực hành:** 
        *   Hoàn thành [Lab 1 (MinIO Ingestion)](../04_minio/labs/lab_1_csv_to_minio.md) (Đọc dữ liệu CSV và lưu vào MinIO).
        *   Chuẩn bị cấu hình cơ sở dữ liệu và bắt đầu triển khai [Lab 2 (Docker Compose & DB Ingestion)](../02_docker/labs/lab_2_compose_stack.md).
    *   **Tài liệu đọc:**
...
*   **Tuần 5: Data Warehouse Concepts & Dimensional Modeling**
    ...
    *   **Thực hành:** Hoàn thành [Lab 2 (Docker Compose & DB Ingestion)](../02_docker/labs/lab_2_compose_stack.md) (Viết Python Repository để ingest dữ liệu vào Postgres và chạy truy vấn phân tích SQL).
    *   **Tài liệu đọc:**
...
*   **Tuần 6: Data Transformation với dbt (Data Build Tool)**
    ...
    *   **Thực hành:** Hoàn thành [Lab 1 (dbt Transformation)](labs/lab_1_dbt.md).
    *   **Tài liệu đọc:**
...
*   **Tuần 8: PySpark Optimization & Lakehouse Formats**
    ...
    *   **Thực hành:** Hoàn thành [Lab 2 (PySpark Big Data)](labs/lab_2_pyspark.md).
    *   **Tài liệu đọc:**
...
*   **Tuần 10: Capstone Project & Best Practices**
    ...
    *   **Thực hành:** Hoàn thành [Lab 3 (Capstone Project)](labs/lab_3_capstone.md).
...
*   👉 **[Checklist Kiến thức cần nắm được - Data Engineering (Nâng cao)](knowledge_checklist.md)**
