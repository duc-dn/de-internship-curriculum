...
*   **Bài tập thực hành:**
    *   👉 **[Lab 1: Cấu trúc dữ liệu & Logic Python cơ bản](labs/lab_1_basics.md)** (30 bài tập bao gồm List, Dict, Set, Strings, Datetime).
...
*   **Bài tập thực hành:**
    *   👉 **[Lab 2: Python Scripting & Data Cleansing](labs/lab_2_json_cleansing.md)** (Làm sạch file JSON thô, xử lý SĐT/Email, ghi log và xuất CSV).
...
*   **Bài tập thực hành (Yêu cầu báo cáo & Slide):**
    *   👉 **[Lab 6: Tối ưu bộ nhớ với Generators & Data Streaming](labs/lab_6_memory_generators.md)** (Streaming file CSV cực lớn, đo lượng Peak RAM, làm slide so sánh và thuyết trình).
    *   👉 **[Lab 7: Custom Decorators & Cơ chế Chịu lỗi](labs/lab_7_decorators_resilience.md)** (Xây dựng decorator tính giờ hiệu năng `@timer` và retry gọi API lỗi với exponential backoff `@retry`, làm slide và thuyết trình).
...
*   **Bài tập thực hành:**
    *   👉 **[Lab 4: Phân tích dữ liệu doanh thu cửa hàng](labs/lab_4_pandas_sales.md)** (Tính toán doanh thu danh mục sản phẩm, tìm top khách hàng và xuất file Parquet).
...
*   **Bài tập thực hành:**
    *   👉 **[Lab 5: Pipeline xử lý dữ liệu song song](labs/lab_5_parallel_processing.md)** (Quét và làm sạch 30 file CSV song song, có đo lường và so sánh thời gian chạy thực tế).
...
*   **Bài tập thực hành:**
    *   👉 **[Lab 3: Python OOP API Weather Client](labs/lab_3_weather_client.md)** (Xây dựng API Client bằng OOP, Custom Exceptions, Logging và viết test cases mock API response đạt test coverage >80%).
...
*   👉 **[Checklist Kiến thức cần nắm được - Python Lập trình nâng cao](knowledge_checklist.md)**
